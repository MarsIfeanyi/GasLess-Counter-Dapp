...
const IncrementNumber = ({ smartAccount, address, provider }: Props) => {
  ...
  const handleIncrement = async () => {
    ...
    try {
      ...
      const incrementNumberTx = await contract.populateTransaction.increment();
